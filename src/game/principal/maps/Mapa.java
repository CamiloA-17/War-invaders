...
//                    Rectangle area = new Rectangle(puntoX, puntoY, Constante.LADO_SPRITE, Constante.LADO_SPRITE);
...
//                }
    ...
    public Rectangle obtenerBordes(final int posicionX, final int posicionY, final int anchoJugador, final int altoJugador) {
        ...
        int ancho = this.ancho * Constante.LADO_SPRITE - anchoJugador * 2;
        int alto = this.alto * Constante.LADO_SPRITE - altoJugador * 2;
